...
This project use React and fetch data from an API RoR project to render a component greeting that show a random greeting.

[Back-end-Link](https://github.com/VaneCode/hello-rails-back-end-)
